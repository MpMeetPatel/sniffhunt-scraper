...
Usage:
  bun cli.js <url> [options]
  bun run cli <url> [options]
...
Examples:
  ...
  bun cli.js https://example.com -o my-output
  
  # With user query for focused extraction
  bun cli.js https://docs.example.com -q "API documentation"
  
  # Using normal mode
  bun cli.js https://example.com -m normal
  
  # Complete example
  bun cli.js https://example.com -o pricing -q "Find pricing information" -m beast
